...
impl MatchOperation {
    fn new(im1: &str, im2: &str, expected_val: f64) -> MatchOperation {
        MatchOperation {
            im1: im1.to_string(),
            im2: im2.to_string(),
            max_delta: 0.0001,
    ...
    fn match_images(&self, img1: &str, img2: &str) -> f64 {
    ...
    fn run_test(&mut self, expected_val: f64) {
